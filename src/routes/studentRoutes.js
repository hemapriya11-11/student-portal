...
router.put("/:id",validate(studentIdSchema, "params"),validate(updateStudentSchema, "body"),updateStudent);
router.delete("/:id",validate(studentIdSchema, "params"),deleteStudent);
router.patch("/:id",validate(studentIdSchema, "params"),validate(patchStudentSchema, "body"),patchStudent);
